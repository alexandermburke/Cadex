...
export default function Sidebar({ activeLink, isSidebarVisible, toggleSidebar, isAiTutor }) {
  ...
  return (
    <motion.aside
      className={`z-[49] fixed top-0 left-0 w-3/4 sm:w-80 md:w-96 h-full ${sidebarBackground} text-white flex flex-col md:relative md:translate-x-0 overflow-y-auto transition-colors duration-500 shadow-xl rounded-lg`}
      initial="hidden"
