...
<p>Login to your account!</p>
      ...
      <div className='flex flex-col gap-4 text-base sm:text-lg'>
        ...
        <input value={email} onChange={(e) => setEmail(e.target.value)} className='flex-1 bg-white rounded max-w-[600px] mx-auto w-full outline-none border border-solid border-white p-4 ' placeholder='Email' />
        <input value={password} onChange={(e) => setPassword(e.target.value)} type='password' className='flex-1 bg-white rounded max-w-[600px] mx-auto w-full outline-none border border-solid border-white p-4 ' placeholder='Password' />
