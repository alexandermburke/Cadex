...
export default function Header() {
    ...
    let navActions = (
        <nav className='hidden items-stretch md:flex'>
            <Link href={'/admin'} className='border border-solid duration-200 border-transparent hover:border-yellow-500 px-4 grid place-items-center rounded-lg'>
                <p>Practice</p>
            </Link>
            <Link href={'/stats'} className='border border-solid duration-200 border-transparent hover:border-yellow-500 px-4 grid place-items-center rounded-lg'>
                <p>Analytics</p>
            </Link>
            <Link href={'/admin'} className='border border-solid duration-200 border-transparent hover:border-yellow-500 px-4 grid place-items-center rounded-lg'>
                <p>{currentUser ? 'Dashboard' : 'Login'}</p>
            </Link>
            <Link href={'/careers'} className='ml-4 duration-200 overflow-hidden p-0.5 rounded-lg relative'>
                <div className='absolute inset-0 goldBackground' />
