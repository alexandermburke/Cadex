...
export default function Header() {
    ...
    let menuActions = (
        <nav className='flex flex-col gap-2'>
            <Link className='p-2 rounded-lg border-solid border duration-200 text-lg hover:bg-blue-950 border-blue-950 border-x-4 border-y-4' href={'/admin'}><p>Practice</p></Link>
            <Link className='p-2 rounded-lg border-solid border duration-200 text-lg hover:bg-blue-950 border-blue-950 border-x-4 border-y-4' href={'/pricing'}><p>Pricing</p></Link>
            <Link className='p-2 rounded-lg border-solid duration-200 text-lg hover:bg-blue-950 border-blue-950 border-x-4 border-y-4' href={'/admin'}><p>Login</p></Link>
